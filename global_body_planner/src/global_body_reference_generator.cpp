...
GlobalBodyReferenceGenerator::GlobalBodyReferenceGenerator(ros::NodeHandle nh) {
    nh_ = nh;
    ...
    terrain_map_sub_ = nh_.subscribe(
            terrain_map_topic_, 1, &GlobalBodyReferenceGenerator::terrainMapCallback, this);
    robot_state_sub_ = nh_.subscribe(
            robot_state_topic_, 1, &GlobalBodyReferenceGenerator::robotStateCallback, this);
    goal_state_sub_ = nh_.subscribe(goal_state_topic, 1,
                                    &GlobalBodyReferenceGenerator::goalStateCallback, this);
...
void GlobalBodyReferenceGenerator::terrainMapCallback(
...
void GlobalBodyReferenceGenerator::setStartState() {
...
void GlobalBodyReferenceGenerator::setGoalState() {}

bool GlobalBodyReferenceGenerator::callPlanner() {
...
void GlobalBodyReferenceGenerator::waitForData() {
...
void GlobalBodyReferenceGenerator::getInitialPlan() {
...
void GlobalBodyReferenceGenerator::publishCurrentPlan() {
...
void GlobalBodyReferenceGenerator::spin() {
